 ...
 */
public fun List<String?>?.isValidOutput(): Boolean {
 ...
 */
public fun String.escapeForShell(): String {
    return "'" + this.replace("'", "'\\''") + "'"
}
 ...
 */
public suspend fun Shell.fastCmdResult(vararg commands: String): Boolean {
